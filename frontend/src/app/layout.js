...
export const metadata = {
  ...
  description: 'Israel Otamere (DyCoder), Software Engineer and Full-Stack Developer building premium, scalable web applications. Available for freelance and contract work in Nigeria.',
  ...
  openGraph: {
    ...
    description: 'Software Engineer building premium, scalable web applications and embedded systems.',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'Israel Otamere (DyCoder) - Full-Stack Software Engineer',
    description: 'Building premium web applications with React, Next.js, Node.js, and Laravel',
    creator: '@dy_coder_',
    images: ['/dp.jpeg']
  },
